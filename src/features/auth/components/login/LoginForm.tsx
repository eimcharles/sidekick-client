...
return (
  <div className="flex-1 flex items-center justify-center">
    <form onSubmit={handleFormSubmission} className="w-full max-w-md flex flex-col gap-6 px-2">
        
        {/* Login Header */}
        <div className="text-center">
          <h1 className="text-[48px] font-extrabold text-gray-900 tracking-tight leading-none">Welcome Back</h1>
          <p className="text-[16px] font-semibold text-slate-400 mt-2"> Sign in with username and password.</p>
        </div>
        ...
        <div className="flex items-center justify-between">
          ...
          <a href="/forgot-password" className="text-[16px] font-semibold text-slate-400 hover:text-teal-600 active:text-teal-600 transition-colors duration-300 cursor-pointer"> Forgot Password?
          </a>
        </div>
        ...
        {/* Sign up Link */}
        <div className="group flex justify-center text-[16px] font-semibold text-slate-400"> Don't have an account?
